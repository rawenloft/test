    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Tools', 'Tools'), ('Books', 'Books'), ('Spells', 'Spells'), ('Potions', 'Potions'), ('Herbs', 'Herbs'), ('Others', 'Others')], max_length=20, verbose_name='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_id', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, related_name='item_to_buy', to='auctions.listing')),
                ('start_bid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='initial_price', to='auctions.listing')),
            ],
        ),
    ]
